...
<head>
    ...
    <style>
        /* Estilo opcional: asegura que la descripción se trunque a 3 líneas con puntos suspensivos */
        .descripcion-clamp {
            display: -webkit-box;
            -webkit-line-clamp: 3; /* Límite a 3 líneas */
                       ...
                       <div class="col d-flex">
                           <div class="card shadow-sm flex-fill">
                               ...
                               <div class="card-body d-flex flex-column text-center">
                                   ...
                                   <p class="card-text text-muted flex-grow-1 descripcion-clamp">
                                      <%= p.getDescripcion() %>
                                   </p>
