...
<div class="container my-5">
    ...
    <!-- ✅ Botón compatible con el servlet -->
    <div class="d-flex justify-content-end mb-4">
        <a href="SeProducto?accion=nuevo" class="btn btn-success btn-lg">
            Agregar Producto
        </a>
    </div>
            ...
            <div class="card shadow-sm flex-fill">
                ...
                <div class="card-body d-flex flex-column text-center">
                    ...
                    <div class="d-flex justify-content-center flex-wrap">
                        ...
                        <!-- ✅ Editar con el servlet -->
                        <a href="SeProducto?accion=editar&id=<%= p.getId() %>" class="btn btn-warning btn-sm me-2 mb-1">Editar</a>

                        <!-- ✅ Eliminar con el servlet -->
